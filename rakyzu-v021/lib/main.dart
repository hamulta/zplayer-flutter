...
class _MusicHomePageState extends State<MusicHomePage> {
  ...
  String _duplicateKey(SongModel song) {
    ...
    final artist = _normalized(_smartArtistOrAlbum(song));
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SwitchListTile(
                      ...
                      title: const Text('Sembunyikan file identik', style: TextStyle(color: Color(0xFFF4F1EA))),
                      subtitle: const Text('Berdasarkan judul + creator + durasi', style: TextStyle(color: Color(0xFFA9A5A0))),
                    ),
                    SwitchListTile(
                      contentPadding: EdgeInsets.zero,
                      value: _hideNoise,
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                Text(
                  loading ? 'Scanning library...' : '$sortLabel • $hiddenCount disembunyikan dari $totalCount audio',
                  maxLines: 1,
                  overflow: TextOverflow.ellipsis,
