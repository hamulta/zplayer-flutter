...
class _MusicHomePageState extends State<MusicHomePage> {
  ...
  String _duplicateKey(SongModel song) {
    ...
    final artist = _normalized(_safeArtist(song));
  ...
  String _safeArtist(SongModel song) {
    ...
    if (artist == null || artist.trim().isEmpty || artist == '<unknown>') return 'Unknown Artist';
    return artist;
  }

  String _safeAlbum(SongModel song) {
    final album = song.album;
    if (album == null || album.trim().isEmpty || album == '<unknown>') return 'Unknown Album';
    return album;
  }
  ...
  void _setRemoveDuplicates(bool value) {
    setState(() {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SwitchListTile(
                      ...
                      title: const Text('Sembunyikan duplikat', style: TextStyle(color: Color(0xFFF4F1EA))),
                      subtitle: const Text('Berdasarkan title + artist + durasi', style: TextStyle(color: Color(0xFFA9A5A0))),
                    ),
                    SwitchListTile(
                      contentPadding: EdgeInsets.zero,
                      value: _hideNoise,
                      ...
                      title: const Text('Filter audio non-musik', style: TextStyle(color: Color(0xFFF4F1EA))),
                      subtitle: const Text('WhatsApp, rekaman, ringtone, notification', style: TextStyle(color: Color(0xFFA9A5A0))),
                    ),
                  ],
                ),
              ),
  ...
  String _songMeta(SongModel song) {
    ...
    return '${_safeArtist(song)} • ${_safeAlbum(song)} • ${_formatDuration(duration)}';
  }
              ...
              child: _loading
                  ...
                  : !_permissionGranted
                      ...
                      : visibleSongs.isEmpty
                          ? _EmptyPanel(hasSearch: _search.trim().isNotEmpty)
                          : ListView.builder(
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                Text(
                  loading ? 'Scanning library...' : '$sortLabel • $hiddenCount hidden dari $totalCount audio',
                  maxLines: 1,
                  overflow: TextOverflow.ellipsis,
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: SingleChildScrollView(
        ...
        child: Row(
          children: [
            _TinyPill(icon: Icons.library_music, text: '$visibleCount tampil / $libraryCount library'),
            const SizedBox(width: 8),
            _TinyPill(icon: Icons.visibility_off, text: '$hiddenCount hidden'),
            const SizedBox(width: 8),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 18),
            Text(
              hasSearch ? 'Tidak ada hasil' : 'Library kosong',
